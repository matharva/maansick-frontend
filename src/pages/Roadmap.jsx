  ...
  return (
    <div>
      ...
      <div>
        ...
        >
          <time
            class="text-lg font-bold text-gray-900 dark:text-black-1200"
            style={{
              position: "absolute",
              left: "20px",
              padding: "15px",
          ...
          >
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                <ReadMore>
                  ...
                  exercise and physical activity can help to lower symptoms of
                  depression and boost energy levels. ResearchTrusted Source
                  suggests that, for some people, exercise can be as effective
                  as medication at relieving depression symptoms. It may also
                  help preventTrusted Source future depressive episodes. Even
                  when you have the feeling that you’re unable to or have very
                  little energy, see if you’d be willing to do the opposite of
                  what your mood is telling you to do, such as curling up in
                  bed. Instead, set a small goal for yourself, such as taking a
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                <ReadMore>
                  ...
                  diary can help to remember this. If you were unsuccessful at
                  getting out of bed or accomplishing your goals today, remember
                  that you haven’t lost tomorrow’s opportunity to try again.
                  Give yourself the grace to accept that while some days will be
                  difficult, some days will also be less difficult. Try to look
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                Push yourself to recognize the good. If it helps, write down
                what was meaningful about the event or day. You can track what
                you achieved that day, and which activities were enjoyable.
                Seeing the weight you’re giving to one thing may help you direct
                your thoughts away from the whole and to the individual pieces
                that were helpful.
              </p>
            </li>
          </motion.h1>
          ...
          >
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                structured, routine that can help you keep your daily pace
                going.
              </p>
            </li>
            {/* 6 */}
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                in your mood or energy, which can further motivate you to
                continue to engage in helpful activities that help with
                navigating symptoms.
              </p>
            </li>
            {/* 7 */}
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                emotions. Music may be especially beneficial when performed in
                group settings, such as a musical ensemble or band. You can also
                reap some of the same rewards simply by listening.
              </p>
            </li>
            {/* 8 */}
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                in person, phone calls or video chats can also be helpful. Try
                to remind yourself these people care about you. Resist the
                temptation to feel like you’re a burden. You need the
                interaction — and they likely do, too.
              </p>
            </li>
          </motion.h1>
          ...
          >
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                symptoms you’re having each day and identify what causes them.
                You can make a goal to write for a few minutes each day or week.
                Most importantly, what you want to write about is completely up
                to you.
              </p>
            </li>
            {/* 10 */}
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                social relationships. To reap these benefits, consider trying a
                new sport, taking a creative class, or learning a new cooking
                technique.
              </p>
            </li>
            {/* 11 */}
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                journaling may help you improve your sense of well-being and
                feel more connected to what’s happening around you.
              </p>
            </li>
            {/* 12 */}
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                Try to get into a healthy sleeping routine. Going to bed and
                waking up at the same time every day can help you with your
                daily schedule. Getting the proper amount of sleep may also help
                you feel more balanced and energized throughout your day.
              </p>
            </li>
          </motion.h1>
          ...
          >
            ...
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                and name your emotions and try to bring your attention to
                engaging in activities that are helpful instead of focusing on
                the emotions. Seeing the ebb and flow of depressive symptoms can
                be instructive for both self-healing and hope.
              </p>
            </li>
            {/* 14 */}
            <li class="mb-10 ml-4">
              ...
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                your symptoms and help develop a clinical treatment plan
                tailored to your needs. This may include various options, such
                as medication and therapy. Finding the right treatment for you
                may take some time, so be open with your doctor or healthcare
                professional about what is and isn’t working. They’ll work with
